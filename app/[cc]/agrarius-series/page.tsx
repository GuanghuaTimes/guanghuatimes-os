...
const config = {
    ...
    titleCn: "AGRARIUS系列",
    description: "AGRARIUS Biotech Series Products",
    descriptionCn: "AGRARIUS生物科技系列产品",
};
...
export default function AgrariusSeriesPage({ 
    params = { cc: "cn" }, 
    limit, 
    showReadMore = false 
}: { 
    ...
    const allFilteredArticles = (allAgrariusSeries || [])
        ...
        <Shell className="md:pb-10 min-h-[calc(100vh-156px)]">
            ...
            {showReadMore && (
                <div className="flex justify-center mt-8">
                    <Link href={`/${params.cc}/agrarius-series`}>
